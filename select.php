...
<body>
	...
	<div class="row">
		 <div class="container theme-showcase" ><?php
...
<a href="frm_insert.php" class="btn btn-primary btn-lg active" role="button"><span class="glyphicon glyphicon-plus"><span> Insert</a></a>
